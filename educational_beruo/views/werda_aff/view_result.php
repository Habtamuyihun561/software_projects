...
<div style="margin-left: 100px; margin-top: 30px; font-size: 24px; color: red">
If you are not sure or incorrect data please<button style="margin-left: 10px; font-size: 24px; border-radius: 10px; background: blue;  border: none;"><a href="remove.php?id=<?php echo $id; ?>" style="text-decoration: none; color: white">Click hear</a></button>						
</div>
