...
<div id="cpblock">
 ...
 <form id="theForm"  method="post" onsubmit='return  formValidator()'>
    ...
    <span class="flt lp_txtmem">Wereda Affair <span style="color:#00000;">Page</span></span><br />
  ...
  <br> <br> 
    <div class="flt1 lp_boxbg"> 
      <span class="flt1 lp_txtour">our solutions</span><br />
          ...
          <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="setedlist.php" class="flt lp_boxtxt2">Seted result list</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /><a href="unsetteld_list.php" class="flt lp_boxtxt2">Unseted Result List</a><img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="update_profile.php?id=<?php echo $_SESSION['id']; ?>" class="flt lp_boxtxt2">Update profile</a>  </div>
