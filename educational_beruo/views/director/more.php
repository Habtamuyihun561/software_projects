...
<div id="cpblock" style="margin-bottom: 200px;">
    ...
    <center style="margin-top: 20px;">
    		<button style="background: blue; border-radius: 5px; height: 40px; justify-content: center;"> <a href="personal_data.php?id=<?php echo $row['sid']; ?>" style="text-decoration: none; color: white; font-size: 24px;">Fill Student Personal data</a></button>
</center>
    </div>
