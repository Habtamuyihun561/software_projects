...
<div id="cpblock">
 ...
 <form id="theForm"  method="post" onsubmit='return  formValidator()'>
    ...
    <span class="flt lp_txtmem"> <b>Director </b><br><?php echo $_SESSION['full_name']; ?> <span style="color:#00000;"></span></span><br />
  ...
  <br> <br> 
    <div class="flt1 lp_boxbg"> 
      <span class="flt1 lp_txtour">our solutions</span><br />
          ...
          <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="director.php" class="flt lp_boxtxt2">Availble Student List</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /><a href="unavailable.php" class="flt lp_boxtxt2">Unavailble Student List</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="ViewSchedule.php" class="flt lp_boxtxt2">All Student List</a><img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="addstudent.php" class="flt lp_boxtxt2">Add new Student</a>  </div>
