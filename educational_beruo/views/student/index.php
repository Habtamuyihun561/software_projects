...
<div id="cpblock">
 ...
 <form id="theForm"  method="post" onsubmit='return  formValidator()'>
    ...
    <span class="flt lp_txtmem"> <b>Student </b>Page <span style="color:#00000;"></span></span><br />
  ...
  <br> <br> 
    <div class="flt1 lp_boxbg"> 
      <span class="flt1 lp_txtour">our solutions</span><br />
          ...
          <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="notice_view.php" class="flt lp_boxtxt2">Notice</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /><a href="result.php" class="flt lp_boxtxt2">View Your data</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="update_profile.php?id=<?php echo $_SESSION['id']; ?>" class="flt lp_boxtxt2">Update Profile</a><img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="../inc/contactus.php" class="flt lp_boxtxt2">Feedback</a>  </div>
