...
<div id="cpblock">
 ...
 <form id="theForm" action="user/login.php" method="post" onsubmit='return  formValidator()'>
    ...
    <span class="flt lp_txtmem">member <span style="color:#00000;">login</span></span><br />
      <lable style="font-size: 16px;">UserName</lable><input required="required" type="text" name="username" id='username' style="width: 160px; height: 25px; border: none; border-radius: 4px; margin-left: 10px;"> <br> <br>
    ...
    <input  type="submit" name="submit" style="border: none; width: 90px; border-radius: 10px;" value="Login" onclick="validateUsername(document.getElementById('username'), 'Please Enter a Value')"onclick="validateUsername(document.getElementById('password'), 'Please Enter a Value')">&nbsp &nbsp &nbsp 
    <input  type="reset" name="submit" style="border: none; width: 90px; border-radius: 10px;" value="Clear"> <br>
   If you are new <a href="user/registration.php" style="color: white; font-size: 20px; ">Register hear</a>
  </form>
