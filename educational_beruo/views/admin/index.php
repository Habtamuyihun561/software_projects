...
<div id="cpblock">
 ...
 <form id="theForm"  method="post" onsubmit='return  formValidator()'>
      ...
      <img src="../assets/img/lp_imgpair.jpg" style="width: 50px; height: 50px; border-radius: 50%; " alt="" class="flt1 lp_imgpair" /> 
    <span class="flt lp_txtmem">Admin <span style="color:#00000;">Page</span></span><br />
  ...
  <br> <br> 
    <div class="flt1 lp_boxbg"> 
      <span class="flt1 lp_txtour">our solutions</span><br />
          ...
          <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="user_registration.php" class="flt lp_boxtxt2">Add user</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /><a href="userlist.php" class="flt lp_boxtxt2">User List</a> <img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="#" class="flt lp_boxtxt2">update profile</a><img src="../assets/img/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" /> <a href="#" class="flt lp_boxtxt2">logout</a>  </div>
