	...
	?>
      <tr>
        ...
        <td><?php echo $row['shift']; ?></td>
         <td>
         	<a href="edit_schedule.php?id=<?php echo $row['idsc']; ?>" style="text-decoration: none; background: #000999; color: white;">Edit</a>
         	 <a href="delete.php?id=<?php echo $row['idsc']; ?>" style="text-decoration: none; background: red; color: white;">Delete</a>
       </tr>
	<?php
}
