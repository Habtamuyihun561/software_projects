...
<div style="margin-left: 200px; margin-top: 30px; font-size: 24px; color: white">
Total <?php echo $sum; ?><button style="margin-left: 10px; font-size: 24px; border-radius: 10px; background: blue;  border: none;"><a href="roster.php?id=<?php echo $id; ?>&sum=<?php echo $sum; ?>" style="text-decoration: none; color: white">Make Roster</a></button>						
</div>
